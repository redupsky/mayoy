...
type alias ConnectionError = (String, Int)
...
localhost = ConnectionParameters ("localhost", 3306) "root" "" Nothing
...
type alias Query = ( String, Maybe Result )
...
viewHeader model =
  let
    connectionName = case model.connection of
